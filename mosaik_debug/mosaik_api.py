...
class Simulator(object):
    ...
    *extra_methods* is an optional list of methods that a simulator provides in
    ...
    time_resolution = None  # Will be set by "init()"
    ...
    def event_setter(self, env, sock):
        ...
        set_event api call::
            yield sock.send(["set_event", [event_time], {}])

        *env* and *sock* are the *simpy.io* environment and socket for network
        communication.
